...
(function () {
  ...
  if (base[name] === undefined) {
    base[name] = function () {
      var modules = {},
        cache = {};
      var requireRelative = function requireRelative(name, root) {
...
StripeCheckout.require.define({
  "vendor/ready": function vendorReady(exports, require, module) {
    !function (name, definition) {
      if (typeof module != "undefined") module.exports = definition();else if ( true && _typeof(__webpack_require__.amdO) == "object") !(__WEBPACK_AMD_DEFINE_FACTORY__ = (definition),
...
StripeCheckout.require.define({
  "lib/helpers": function libHelpers(exports, require, module) {
    (function () {
      var delurkWinPhone, helpers, uaVersionFn;
      uaVersionFn = function uaVersionFn(re) {
        return function () {
          var uaMatch;
      ...
      delurkWinPhone = function delurkWinPhone(fn) {
        return function () {
      ...
      helpers = {
        ...
        isiOSFirefox: function isiOSFirefox() {
        ...
        isAndroidFacebookApp: function isAndroidFacebookApp() {
        ...
        couldBeBrokenSFSVC: function couldBeBrokenSFSVC() {
          var iOSVersion;
        ...
        isSafariStandaloneMode: function isSafariStandaloneMode() {
          return window.navigator && window.navigator.standalone;
        },
        getViewportTags: function getViewportTags() {
        ...
        isFullscreenMobileCapableViewport: function isFullscreenMobileCapableViewport() {
        ...
        iOSChromeTabViewWillFail: function iOSChromeTabViewWillFail() {
        ...
        replaceFullWidthNumbers: function replaceFullWidthNumbers(el) {
          var _char, fullWidth, halfWidth, idx, j, len, original, ref, replaced;
        ...
        dashToCamelCase: function dashToCamelCase(dashed) {
          return dashed.replace(/-(\w)/g, function (match, _char2) {
            return _char2.toUpperCase();
          });
        },
        camelToDashCase: function camelToDashCase(cameled) {
        ...
        extractBrowserFamily: function extractBrowserFamily(userAgent) {
...
StripeCheckout.require.define({
  "lib/spellChecker": function libSpellChecker(exports, require, module) {
    (function () {
      var levenshtein;
      module.exports = {
        levenshtein: levenshtein = function levenshtein(str1, str2) {
        ...
        suggest: function suggest(dictionary, badword, threshold) {
...
StripeCheckout.require.define({
  "lib/optionHelpers": function libOptionHelpers(exports, require, module) {
    (function () {
      ...
      flatten = function flatten(obj) {
        ...
        for (key in obj) {
          val = obj[key];
          if ((ref = _typeof(val)) === "function" || ref === "object") {
            flattened[key] = "" + val;
          } else {
            flattened[key] = val;
          }
      ...
      truncate = function truncate(val, cap) {
        if (val.length - 3 > cap) {
      ...
      dumpObject = function dumpObject(obj) {
        return truncate(repr(obj), 50);
      };
      prettyPrint = function prettyPrint(key, rawOptions) {
        var original, ref;
...
StripeCheckout.require.define({
  "lib/paymentMethods": function libPaymentMethods(exports, require, module) {
    (function () {
      var ERROR,
        METHODS,
        OPTIONAL,
      ...
      alipayEnabled = function alipayEnabled(key, val, options) {
      ...
      isValidMethod = function isValidMethod(method) {
      ...
      simpleMethodTypeCheck = function simpleMethodTypeCheck(method) {
        var prettyMethod;
      ...
      deepMethodTypeCheck = function deepMethodTypeCheck(methodSettings) {
      ...
      singleMethodTypeCheck = function singleMethodTypeCheck(method, idx) {
      ...
      spec = function spec(key, val, options) {
        var actualType, error, i, idx, len, method;
        if (val === null) {
          return null;
        }
        if (!helpers.isArray(val)) {
          actualType = val === null ? "null" : _typeof(val);
          return {
            type: ERROR,
      ...
      checkNoDuplicates = function checkNoDuplicates(val) {
      ...
      checkNoOldAPI = function checkNoOldAPI(options) {
      ...
      checkContext = function checkContext(key, val, options) {
        var error;
      ...
      coerceDefaults = function coerceDefaults(methodSpec, methodSettings) {
        var results, setting;
        results = [];
      ...
      simpleToCanonical = function simpleToCanonical(method, enabled) {
        var methodSettings;
        methodSettings = {
          method: method,
          enabled: enabled
      ...
      alipayToCanonical = function alipayToCanonical(enabled, reusable) {
        var methodSettings;
        methodSettings = {
          method: "alipay",
          enabled: enabled,
      ...
      transformMethods = function transformMethods(paymentMethods) {
      ...
      methodsArrayToDict = function methodsArrayToDict(paymentMethods) {
      ...
      canonicalize = function canonicalize(rawOptions) {
...
StripeCheckout.require.define({
  "lib/optionSpecs": function libOptionSpecs(exports, require, module) {
    (function () {
      ...
      OPTIONS = {
        ...
        alipay: {
          importance: OPTIONAL,
          type: OTHER,
          coerceTo: function coerceTo(val) {
            if (val === "auto") {
              return val;
            }
        ...
        token: {
          importance: function importance(integrationType, isConfigure) {
            if (isConfigure) {
              return OPTIONAL;
            } else {
      ...
      generateOptions = function generateOptions(arg) {
...
StripeCheckout.require.define({
  "lib/optionValidator": function libOptionValidator(exports, require, module) {
    (function () {
      var ERROR,
      ...
      REQUIRED = "required";
      PRIVATE = "private";
      isRequired = function isRequired(importance) {
        return importance === REQUIRED;
      };
      fromSpec = function fromSpec(optionSpec) {
        var opt, val;
        return {
          all: optionSpec,
          required: function () {
      ...
      simpleTypeCheck = function simpleTypeCheck(expectedType, val) {
        var actualType;
        actualType = _typeof(val);
      ...
      simpleNullableTypeCheck = function simpleNullableTypeCheck(expectedType, val) {
        if (val === null) {
          return null;
        }
        return simpleTypeCheck(expectedType, val);
      };
      isString = function isString(key, val, options) {
        return simpleTypeCheck("string", val);
      };
      isBoolean = function isBoolean(key, val, options) {
        return simpleTypeCheck("boolean", val);
      };
      isNumber = function isNumber(key, val, options) {
        return simpleTypeCheck("number", val);
      };
      isNullableString = function isNullableString(key, val, options) {
        return simpleNullableTypeCheck("string", val);
      };
      isNullableBoolean = function isNullableBoolean(key, val, options) {
        return simpleNullableTypeCheck("boolean", val);
      };
      isNullableNumber = function isNullableNumber(key, val, options) {
        return simpleNullableTypeCheck("number", val);
      };
      ignore = function ignore() {
        return null;
      };
      xRequiresY = function xRequiresY(requiring, required) {
      ...
      xPrecludesY = function xPrecludesY(x, y) {
        return function (key, val, options) {
          var prettyX, prettyY;
      ...
      coerceOption = function coerceOption(optionSpec, option, val) {
        var OPTIONS;
      ...
      checkRequiredOptions = function checkRequiredOptions(OPTIONS, arg, rawOptions) {
      ...
      checkConditionallyRequiredOptions = function checkConditionallyRequiredOptions(OPTIONS, arg, rawOptions) {
      ...
      checkUnrecognizedOptions = function checkUnrecognizedOptions(OPTIONS, arg, rawOptions) {
      ...
      checkOptionTypes = function checkOptionTypes(OPTIONS, arg, rawOptions) {
      ...
      checkOptionContexts = function checkOptionContexts(OPTIONS, arg, rawOptions) {
        var error, errors, filtered, message, option, type, val, warnings;
        errors = arg.errors, warnings = arg.warnings;
        filtered = {};
        for (option in rawOptions) {
      ...
      validate = function validate(optionSpec, rawOptions) {
...
StripeCheckout.require.define({
  "lib/optionParser": function libOptionParser(exports, require, module) {
    (function () {
      ...
      extractValue = function extractValue(rawOptions, key) {
      ...
      formatMessage = function formatMessage(origin, message) {
        return "StripeCheckout." + origin + ": " + message + "\nYou can learn about the available configuration options in the Checkout docs:\n" + CHECKOUT_DOCS_URL;
      };
      _trackIndividual = function _trackIndividual(level, origin, rawOptions, error) {
      ...
      trackSummary = function trackSummary(parameters, rawOptions) {
      ...
      trackError = function trackError(origin, rawOptions, error) {
        return _trackIndividual("error", origin, rawOptions, error);
      };
      trackWarning = function trackWarning(origin, rawOptions, error) {
        return _trackIndividual("warning", origin, rawOptions, error);
      };
      module.exports = {
        coerceButtonOption: function coerceButtonOption(option, val) {
          return optionValidator.coerceOption(optionSpecs.buttonConfigureOptions, option, val);
        },
        parse: function parse(rawOptions) {
        ...
        checkUsage: function checkUsage(origin, rawOptions, isDarkMode) {
...
StripeCheckout.require.define({
  "lib/keymode": function libKeymode(exports, require, module) {
    (function () {
...
StripeCheckout.require.define({
  "lib/rpc": function libRpc(exports, require, module) {
    (function () {
      var RPC,
        helpers,
        tracker,
...
StripeCheckout.require.define({
  "lib/uuid": function libUuid(exports, require, module) {
    (function () {
      var S4;
      S4 = function S4() {
...
StripeCheckout.require.define({
  "lib/pixel": function libPixel(exports, require, module) {
    (function () {
      ...
      track = function track(event, params, callback) {
...
StripeCheckout.require.define({
  "lib/tracker": function libTracker(exports, require, module) {
    (function () {
      var config,
        helpers,
        isEventNameExisting,
      ...
      tracker.track = {
        outerOpen: function outerOpen(parameters) {
          var requiredKeys;
          requiredKeys = ["key"];
        ...
        selfHostedError: function selfHostedError() {
          return track("outer.selfHosted");
        },
        tabOpeningError: function tabOpeningError() {
        ...
        iOSWebViewType: function iOSWebViewType() {
          var type;
        ...
        tokenError: function tokenError(msg) {
          return track("token.error", {
            message: msg,
            type: "exception"
          });
        },
        sourceError: function sourceError(msg) {
          return track("source.error", {
            message: msg,
            type: "exception"
          });
        },
        back: function back(parameters) {
          return track("back", parameters, ["from_step", "to_step"]);
        },
        token: function token(parameters) {
          return track("token", parameters, ["stripe_token"]);
        },
        source: function source(parameters) {
          return track("source", parameters, ["stripe_source"]);
        },
        i18nLocKeyMissing: function i18nLocKeyMissing(key) {
          return track("i18n.loc.missingKey", {
            template_key: key
          });
        },
        i18nLocPartiallyReplacedTemplate: function i18nLocPartiallyReplacedTemplate(key, value) {
          return track("i18n.loc.partiallyReplacedTemplate", {
            template_key: key,
            template_value: value
          });
        },
        i18nFormatLocaleMissing: function i18nFormatLocaleMissing(locale) {
          return track("i18n.format.localeMissing", {
            locale: locale
          });
        },
        alert: function alert(parameters) {
      ...
      tracker.trace = {
        trigger: function trigger(eventName, args) {
          ...
          if (indexOf.call(EXCLUDED_EVENTS, eventName) < 0) {
            ...
            this._triggerQueue[eventName] = _traceSerialize(args);
        ...
        rpcInvoke: function rpcInvoke(method) {
          return trace("rpc.invoke." + method);
        },
        rpcPostMessage: function rpcPostMessage(method, args, id) {
          return trace("rpc.postMessage." + method, {
            id: id,
            args: _traceSerialize(args)
          });
        }
      };
      tracker.state = {
        setUIType: function setUIType(type) {
          return stateParameters["st-ui-type"] = type;
        },
        setUIIntegration: function setUIIntegration(integration) {
        ...
        setFeature: function setFeature(name, variant, selector) {
          stateParameters["st-variant-" + name] = variant;
          return stateParameters["st-selector-" + name] = selector;
        },
        setRequestedLocale: function setRequestedLocale(locale) {
      ...
      isEventNameExisting = function isEventNameExisting(eventName) {
        var exists, k, ref, v;
        exists = false;
        ref = tracker.events;
        for (k in ref) {
      ...
      trace = function trace(eventName, parameters, requiredKeys, options) {
        if (parameters == null) {
          parameters = {};
        }
      ...
      track = function track(eventName, parameters, requiredKeys, options) {
      ...
      _traceSerialize = function traceSerialize(value) {
        var k, obj, v;
        if (value instanceof Array) {
          return JSON.stringify(function () {
            ...
            for (i = 0, len = value.length; i < len; i++) {
              v = value[i];
              results.push(_traceSerialize(v));
            }
            return results;
          }());
        } else if (value != null && value.target != null && value.type != null) {
          return _traceSerialize({
            type: value.type,
...
StripeCheckout.require.define({
  "outer/lib/origins": function outerLibOrigins(exports, require, module) {
    (function () {
      var isLocalhost, isStripeHosted;
      isStripeHosted = function isStripeHosted(src) {
        return src.match(/checkout\.stripe\.com/);
      };
      isLocalhost = function isLocalhost(src) {
...
StripeCheckout.require.define({
  "outer/lib/utils": function outerLibUtils(exports, require, module) {
    (function () {
      var $,
        $$,
        addClass,
      ...
      trigger = function trigger(element, name, data, bubble) {
        if (data == null) {
          data = {};
        }
        if (bubble == null) {
      ...
      insertBefore = function insertBefore(element, child) {
...
StripeCheckout.require.define({
  "outer/controllers/app": function outerControllersApp(exports, require, module) {
    (function () {
      var App,
        Checkout,
        RPC,
...
StripeCheckout.require.define({
  "outer/controllers/button": function outerControllersButton(exports, require, module) {
    (function () {
      var $$,
        Button,
        addClass,
...
StripeCheckout.require.define({
  "outer/controllers/checkout": function outerControllersCheckout(exports, require, module) {
    (function () {
      var Checkout,
        IframeView,
        TabView,
      ...
      Checkout = function () {
        ...
        Checkout.prototype.createView = function () {
          ...
          path = "/v3/oivkx0oP8BgueCG8QFpDfA.html?distinct_id=" + tracker.getDistinctID();
        ...
        Checkout.prototype.open = function (options) {
          ...
          iframeFallback = function (_this) {
            return function () {
              ...
              _this.view = new IframeView(_this.onToken, _this.host, "/v3/oivkx0oP8BgueCG8QFpDfA.html");
...
StripeCheckout.require.define({
  "outer/controllers/tokenCallback": function outerControllersTokenCallback(exports, require, module) {
    (function () {
      var TokenCallback,
        bind = function bind(fn, me) {
          return function () {
...
StripeCheckout.require.define({
  "outer/views/iframeView": function outerViewsIframeView(exports, require, module) {
    (function () {
      var IframeView,
        RPC,
        View,
...
StripeCheckout.require.define({
  "outer/views/tabView": function outerViewsTabView(exports, require, module) {
    (function () {
      var RPC,
        TabView,
        View,
...
StripeCheckout.require.define({
  "outer/views/view": function outerViewsView(exports, require, module) {
    (function () {
      var View,
        bind = function bind(fn, me) {
          return function () {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/checkout.js");
/******/ 	
/******/ })()
;